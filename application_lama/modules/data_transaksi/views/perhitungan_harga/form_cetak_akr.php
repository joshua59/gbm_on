...
<table border="0" style="width:100%;">
    <tr>
        <td style="width:9%;text-align:left"></td>
        <td style="width:1%;text-align:center"></td>
        <td style="width:90%;text-align:justify">Mengacu PJB-BBM (HSD) antara AKR dan PLN untuk <?php echo $list_unit[0]->LEVEL1;?> No. PLN <?php echo $val->NOPJBBM;?> yang berlaku efektif mulai tanggal <?php echo $tgl_awal_kontrak;?>.<br><br>Dengan ini kami sampaikan Harga Pembelian BBM (HSD) untuk bulan <?php echo $periode;?> dari AKR sebagai berikut : 
        </td>
    </tr>    
</table>
<br>
    ...
    foreach ($list as $row) {
        ...
        <table border="0" style="width:100%;">  
            ...
            <tr>
                ...
                <td style="text-align:center"></td>
                <td style="text-align:center">=</td>        
                <td style="text-align:center">('.$param->ALPHA1.') * (MOPS '.$param->MOPS_PERSEN.' * '.$param->PERSEN.') * (1,1) * ('.$jns_kurs.')<hr style="margin:1px">'.$param->KONVERSI_BARREL.'</td>
                <td style="text-align:center">+</td>
                    ...
                    <table style="width:100%;" class="tdetail">  
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td style="text-align:left">'.$param->ALPHA2.' untuk</td>
                            </tr>
                            <tr>
