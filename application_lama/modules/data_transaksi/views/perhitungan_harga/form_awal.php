...
<script type="text/javascript">
    ...
    function get_mops(id){ 
        ...
        if(id == 1){
            var urlna="<?=base_url()?>data_transaksi/perhitungan_harga/get_mid_mops/";
        } else if(id == 2) {
            var urlna="<?=base_url()?>data_transaksi/perhitungan_harga/get_low_mops/";
        } if(tgl1 == '' || tgl2 == '') {
    ...
    function formula_akrkpm(){ 
        ...
        var urlna="<?=base_url()?>data_transaksi/perhitungan_harga/formula_akrkpm/";
        ...
        bootbox.confirm('Apakah yakin akan menyimpan data ?', "Tidak", "Ya", function(e) {
            if(e){
                if(id == 1){   
                    ...
                    var urlna="<?=base_url()?>data_transaksi/perhitungan_harga/save/";
                }
                // else if(id == 2)
                else
                {
