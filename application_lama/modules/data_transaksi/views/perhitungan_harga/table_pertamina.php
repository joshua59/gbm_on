    ...
    <div class="well-content no-search">
        ...
        <div class="well-content no-search">
            <div class="control-group">
                ...
                <span style="display:inline-block">
                    <label for="mfo" style="display:block">MFO LSFO:</label>
                    <input type="text" name="avgmidmfo" class="form-control span4" placeholder="avg mid MFO" style="width: 90px;color: black;font-weight: bold;" readonly="" value="<?php echo number_format($avg_mid_mfo_lsfo,2,',','.') ?>" id="AVGMIDMFOLSFO">
                </span>
                <span style="display:inline-block">
                ...
                <span style="display:inline-block">
                    <label for="ktbi" style="display:block">PPN:</label>
                    <input type="text" name="PPN" class="form-control span4" placeholder="PPN" style="width: 90px;color: black;font-weight: bold;" readonly="" value="<?php echo !empty($ppn) ? $ppn : '10'?> %">
                </span>
            </div>
        </div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align: right">
                        ...
                        <input type="hidden" name="alfamid_mfo_lsfo" id="alfamid_mfo_lsfo" value="<?php echo number_format((float)$alfamid_mfo_lsfo,2,',','.') ; ?>">
                    </td>
                    <td style="text-align: right">
