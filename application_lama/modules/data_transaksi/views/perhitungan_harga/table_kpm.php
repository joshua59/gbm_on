<div class="table_akr">
                ...
                <div class="well-content no-search">
                    <div class="control-group">
                        <span style="display:inline-block">
                            ...
                            <input type="text" name="" class="form-control span4" placeholder="avg low HSD" style="width: 90px;color: black;font-weight: bold;" readonly="" value="<?php echo 
                                    number_format($low_hsd->LOWHSD_MOPS,2,',','.') ?>">
                        </span>
                        <span sty
                        <span style="display:inline-block">
    ...
    ?>
                <table class="table table-responsive table-hover table-striped table-border">
                    <thead>
                         <tr>
                            <th>Harga Tanpa OAT (Rp/Liter)</th>
                            <th>OAT</th>
                            <th>Harga Dengan OAT (Rp/Liter)</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
