...
<table border="0" style="width:100%;">
    <tr>
        <td style="width:9%;text-align:left"></td>
        <td style="width:1%;text-align:center"></td>
        <td style="width:90%;text-align:justify">Mengacu Pada rata-rata MOPS Gasoil <?php echo set_tgl($val->TGLAWAL);?> - <?php echo set_tgl($val->TGLAKHIR);?> yaitu <?php echo number_format($val->MID_HSD_RATA2, 2, ',', '.');?> USD/Barrel, MOPS HSFO <?php echo $param->FO;?> pada <?php echo number_format($val->MID_MFO_RATA2, 2, ',', '.');?> USD/MT dan MOPS LSFO <?php echo $param->FO;?> pada <?php echo number_format($val->MID_MFO_LSFO_RATA2, 2, ',', '.');?> sesuai Perjanjian Jual Beli BBM yang berlaku, dengan ini disampaikan Harga Jual BBM Pertamina untuk PLN Periode <?php echo $periode;?> yang diambil dengan Menggunakan Alat Transport Darat dan Laut sebagai berikut : </td>
    </tr>    
</table>
<br>
    ...
    <tr>
        ...
        <td style="width:80%;text-align:left">
            <table style="width:100%;" class="tdetail">
                <!-- <thead> -->
                    <tr>
                        <th colspan="2" style="text-align:center;padding: 15px;">Harga Periode <?php echo $periode;?></th>
                    </tr>
                <!-- </thead>   -->
...
<table border="0" style="width:100%;">
    ...
    <tr>
        ...
        <!-- <td style="width:90%;text-align:left"><b><i>Untuk pembangkit yang menggunakan BBM jenis MFO, Harga BBM mengacu KEPADA HARGA MFO High Sulfur (HSFO)</i></b></td> -->
    </tr>
    <tr>
        <td style="width:9%;text-align:left"></td>
        <td style="width:1%;text-align:center"></td>
        <td style="width:90%;text-align:justify"><b><i>Untuk pembangkit yang menggunakan BBM jenis MFO, harga BBM mengacu kepada harga MFO High Sulfur (HSFO)</i></b></td>
    </tr>  
</table>
<br><br>
