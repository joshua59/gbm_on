                        ...
                        <div class="controls">
                            <table>
                                <tr>
                                    <td>
                                        <?php 
                                            if (($this->laccess->otoritas('add') == true) && ($this->session->userdata('level_user') >= "2")) {
                                    ...
                                    <td>
                                        <?php 
                                            if (($this->laccess->otoritas('approve') == true) && ($this->session->userdata('level_user') == "2")) {
        ...
        if (!$('#table_detail').is(":visible")) {
            ...
            $.post("<?php echo base_url()?>data_transaksi/permintaan/getDataDetail/", data_kirim, function (data) {
                ...
                for (i = 0; i < data_detail.length; i++) {
                    ...
                    vlink_url = "<?php echo base_url()?>data_transaksi/permintaan/tolak_view/"+data_detail[i].ID_PERMINTAAN;
                    vTolakView = '<a href="javascript:void(0);" class="btn transparant" id="button-tolak-'+data_detail[i].ID_PERMINTAAN+'" onclick="load_form(this.id)" data-source="'+vlink_url+'"> <i class="icon-remove" title="Tolak Data"></i></a>';
