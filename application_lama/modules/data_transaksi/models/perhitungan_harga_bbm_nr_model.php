 ...
 */
class perhitungan_harga_bbm_nr_model extends CI_Model {
    ...
    public function get_hitung_harga_edit($periode=''){ 
        ...
        $q = " SELECT a.*, m1.LEVEL1, m2.LEVEL2, m3.LEVEL3, m4.LEVEL4, s.NAME_SETTING as SKEMA_NAMA 
               FROM TRANS_HITUNG_HARGA_NR a 
               ...
               LEFT JOIN DATA_SETTING s ON s.VALUE_SETTING=a.SKEMA AND s.KEY_SETTING='SKEMA_ISIDENTIL' 
               WHERE DATE_FORMAT(a.TGLAWAL,'%Y%m')='$periode'            
               AND a.KODE_PEMASOK IN('002','003') 
               AND a.STATUS_APPROVE = '2' ".$cari;
    ...
    public function get_akr_kpm($IDTRANS){ 
        $q = "SELECT * FROM TRANS_HITUNG_HARGA_NR WHERE IDTRANS='$IDTRANS' ORDER BY TGLINSERT ASC LIMIT 1";
