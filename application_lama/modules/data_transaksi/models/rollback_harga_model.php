...
class rollback_harga_model extends CI_Model {
    ...
    public function data($key = '') {
        ...
        $this->db->from('LOG_ROLLBACK_TRANS_HITUNG_HARGA a');
    ...
    public function get_id($data) {
        ...
        $this->db->select('*');
        $this->db->from('TRANS_HITUNG_HARGA');
    ...
    public function save_as_new($data) {
        ...
        $query = "CALL ROLLBACK_HARGA('$id_trans','$user')";
