 ...
 */
class perhitungan_harga_bbm extends MX_Controller {

    private $_title = 'HARGA BBM';
    private $_limit = 10;
    private $_module = 'data_transaksi/perhitungan_harga_bbm';
    ...
    public function __construct() {
        ...
        /* Load Global Model */
        $this->load->model('perhitungan_harga_bbm_model', 'tbl_get');
    }
