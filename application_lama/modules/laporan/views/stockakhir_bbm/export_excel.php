 ...
 <table class="tdetail" width="100%" cellspacing="0">
    <thead>
        <tr>
            ...
            <th style="text-align: center" rowspan="2">SHO<br>(Hari)</th>
        </tr>
        <tr>
...
<ul class="dashed">
    <li>(* SHO : Sisa Hari Operasi)</li>
    <li>(* Sisa Hari Operasi (Hari) : untuk pembangkit selain PLTU)</li>
    <li>(* Sisa Hari Operasi (kali start) : untuk pembangkit PLTU) </li>                
</ul>
<table border="0" style="width:100%;">
    <tr><td></td></tr>
