...
<div class="inner_content" id="divTop">
    ...
    <div class="widgets_area">
        ...
        <div class="well-content no-search" id="divTable">
            ...
            <label for="periodeawal_ket"><i>(*Tanggal Awal Pakai : Tanggal pengakuan transaksi pemakaian pertama pada periode tertentu)</i></label><br><br>

            <label for="periodeakhir_ket"><i>(*Tanggal Akhir Pakai : Tanggal pengakuan transaksi  pemakaian terakhir pada periode tertentu)</i></label>
        </div>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="pull-right">
                  <input type="text" id="cariDetail" name="cariDetail" value="" placeholder="Cari Unit, No Pemakaian" class="input-large">
...
<form id="export_pdf" action="<?php echo base_url('laporan/pemakaian/export_pdf'); ?>" method="post" target="_blank">
...
<form id="export_pdf_detail" action="<?php echo base_url('laporan/pemakaian/export_pdf_detail'); ?>" method="post" target="_blank">
    <input type="hidden" name="plvl0">
    <input type="hidden" name="plvl">
    <input type="hidden" name="plvlid">
    <input type="hidden" name="plvl1">
