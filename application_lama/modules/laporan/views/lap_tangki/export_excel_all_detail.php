...
<?php
    if ($JENIS == 'XLS') {
        ...
        header('Content-Disposition: attachment; filename=Laporan_All_Detail_Tangki_BBM.xls');
...
<table border="0" style="width:100%;">
    <tr>
        ...
        <td style="width:80%;text-align:center" colspan="8"><div class="box-kop">LAPORAN ALL DETAIL TANGKI BBM</div></td>
