    ...
    <tbody>
        ...
        foreach ($data as $key => $value) : ?>
            <tr>
                ...
                ?> -->
                <td style="border-collapse: collapse;border :1px solid black;"><?php echo $value['NAMA_REGIONAL'] ?></td>
                <td style="border-collapse: collapse;border :1px solid black;"><?php echo $value['LEVEL1'] ?></td>
                <td style="border-collapse: collapse;border :1px solid black;"><?php echo $value['LEVEL2'] ?></td>
                <td style="border-collapse: collapse;border :1px solid black;"><?php echo $value['LEVEL3'] ?></td>
                <td style="border-collapse: collapse;border :1px solid black;"><?php echo $value['LEVEL4'] ?></td>
