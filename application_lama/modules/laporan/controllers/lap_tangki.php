...
/**
 * lap tangki bbm controller
 * @author stelin
 */
class lap_tangki extends MX_Controller{
    private $_title  = 'Laporan Tangki BBM';
    private $_limit  = 10;
    private $_module = 'laporan/lap_tangki';
    ...
    public function __construct(){
        ...
        $this->load->model('lap_tangki_model', 'tbl_tangki_get');
    }
    ...
    public function index(){
        ...
        $data['opsi_bbm']   = $this->tbl_tangki_get->option_jenisbbm();
    ...
    public function getData(){
        ...
        // print_r($data);
        $data                  = $this->tbl_tangki_get->getData_Model($data);
    ...
    public function getDataDetail(){
        $data = array(
            'ID_BBM'    => $this->input->post('detail_id_bbm'),
            'ID_TANGKI'    => $this->input->post('detail_id_tangki'),
        ...
        $data = $this->tbl_tangki_get->getData_Model_Detail($data);
        echo json_encode($data);
    }
    ...
    public function export_excel(){
        ...
        $data['data'] = $this->tbl_tangki_get->getData_Model($data);
    ...
    public function export_excel_bio(){
        ...
        $data['data'] = $this->tbl_tangki_get->getData_Model_Detail($data);
    ...
    public function export_pdf_bio(){
        ...
        $this->load->library('lpdf');
        $this->lpdf->html($html_source);
        $this->lpdf->nama_file('Detail_Laporan_Penerimaan_BBM.pdf');
        $this->lpdf->cetak('A4-L');
    }      
    
    public function export_excel_all_detail(){
        header('Content-Type: application/json');
        $data                = array(
            // 'LVL0'             => $this->input->post('xlvl'),
            'ID_REGIONAL'      => $this->input->post('xlvl'), // 01
        ...
        $data['data'] = $this->tbl_tangki_get->getData_All_Model_Detail($data);
        $this->load->view($this->_module . '/export_excel_all_detail', $data);
    }
    ...
    public function tempDetail(){
        ...
        $data = $this->tbl_tangki_get->tempgetData_Model_Detail($data);
        echo json_encode($data);
    }
    ...
    public function testDetail(){
        ...
        $data = $this->tbl_tangki_get->testDetail();
        echo json_encode($data);
    }
