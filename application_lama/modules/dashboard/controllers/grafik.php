...
class grafik extends MX_Controller {
    ...
    public function getTableHsdBio()
    {
      ...
      $storesloc = $this->input->post('STORE_SLOC');
      ...
      if($idregional == '' && $cocode =='' && $plant =='' && $storesloc == '' && $sloc == '')
      {
        if ($this->session->userdata('level_user') == '0') {
          $data = $this->tbl_get->getTableHsdBio_All($data);
    ...
    public function getTableBio()
    {
      ...
      {
        if ($this->session->userdata('level_user') == '0') {
          $data = $this->tbl_get->getTableBio_All($data);
          echo json_encode($data);
        }
      }else{
    ...
    public function getTableHsd()
    {
      ...
      $sloc = $this->input->post('SLOC');
        ...
        {
          if ($this->session->userdata('level_user') == '0') {
            $data = $this->tbl_get->getTableHsd_All($data);
            echo json_encode($data);
          }
        }else{
    ...
    public function getTableMfo()
    {
      ...
      $sloc = $this->input->post('SLOC');
        ...
        {
          if ($this->session->userdata('level_user') == '0') {
            $data = $this->tbl_get->getTableMfo_All($data);
            echo json_encode($data);
          }
        }else{
    ...
    public function getTableIdo()
    {
      ...
      $sloc = $this->input->post('SLOC');
        ...
        {
          if ($this->session->userdata('level_user') == '0') {
            $data = $this->tbl_get->getTableIdo_All($data);
            echo json_encode($data);
          }
        }else{
