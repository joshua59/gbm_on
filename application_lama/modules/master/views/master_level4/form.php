<div class="row-fluid">
    ...
    <div class="box-content">
        ...
        <div class="control-group">
            ...
            <label for="password" class="control-label">Status Pemakaian  : 
            <?php echo form_checkbox('STATUS_PEMAKAIAN', '1',!empty($default->STATUS_PEMAKAIAN) ? $default->STATUS_PEMAKAIAN : '1', 'class ="STATUS"' ); ?>  <!-- <b>Status Pemakaian</b> -->
            </label>
        </div>   
        <div class="control-group">
