...
class max_pakai_model extends CI_Model {
	...
	public function data($key = '') {
		$this->db->select("a.VOLUME_MAX_PAKAI, a.THBL_MAX_PAKAI, e.NAMA_JNS_BHN_BKR, a.ID_MAX_PAKAI, b.LEVEL4, c.LEVEL3, d.LEVEL2, a.STATUS_MAX_PAKAI,a.SLOC,a.ID_JNS_BHN_BKR");
