...
*/ 
class kurs_ktbi_model extends CI_Model {

    public function __construct() {
        parent::__construct();
    }

    private $_table1 = "KURS_KTBI"; //nama table setelah mom_
    ...
    public function generate_id_kurs() {
        ...
        $query = $this->db->query('SELECT (MAX(ID_KURS) + 1) as ID_KURS FROM KURS_KTBI')->row();
