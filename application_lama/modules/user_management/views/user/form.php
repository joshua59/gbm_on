<div class="row-fluid">
    ...
    <div class="box-content">
        ...
        <div class="control-group" id="ldap_info">
            <label  class="control-label">Cek User LDAP : <span class="required"></span></label>
            <div class="controls">
        ...
        <div class="control-group">
            <label for="password" class="control-label">Status User LDAP : </label>
            <div class="controls">
            <?php echo form_checkbox('IS_LDAP', '1', !empty($default->IS_LDAP) ? $default->IS_LDAP : '' ); ?>
            </div>
        </div> 
        <hr>
        <div class="control-group">
        ...
        <div class="control-group">
            <label for="password" class="control-label">Status Aktif <span class="required">*</span> : </label>
            <div class="controls">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <span class="required" id="ldap_ket">*) Pengisian "Cek User LDAP" : 'domain\user_ldap' (contoh : pusat\devgbm)</span><br>
                <span class="required">*) Pilihan "Status User LDAP" : dikhususkan untuk user dengan email korporat @pln.co.id</span>
            </div>
        </div>
