<?php
/**
 * @module ROLLBACK STOCKOPNAME
 * @author  CF
 * @created at 24 NOVEMBER 2021
 * @modified at 24 NOVEMBER 2021
 */
class rollback_stockopname_model extends CI_Model {
    ...
    public function get_table($key = ''){
        $this->db->select("c.LEVEL4, JNS_TRANSAKSI, b.NAMA_JNS_BHN_BKR, NO_STOCKOPNAME, TGL_PENGAKUAN, STATUS, ALASAN");
        $this->db->from('LOG_ROLLBACK_STOCKOPNAME1' . ' a');
    ...
    public function data_table($module = '', $limit = 20, $offset = 1) {
        ...
        if (!empty($kata_kunci))
            $filter["NO_STOCKOPNAME LIKE '%{$kata_kunci}%'"] = NULL;
    ...
    public function get_transaksi($sloc, $bbm, $jenis) {
        if($jenis == 1){
            $query = "SELECT * FROM STOCK_OPNAME WHERE SLOC = '$sloc' AND ID_JNS_BHN_BKR = '$bbm' AND (STATUS_APPROVE_STOCKOPNAME = '2' OR  STATUS_APPROVE_STOCKOPNAME = '6')";           
        }
    ...
    public function get_detailtransaksi($idtrans,$jenis){
        ...
        if($jenis == 1){
            $query = "SELECT TGL_BA_STOCKOPNAME,NO_STOCKOPNAME,APPROVE_BY_STOCKOPNAME,APPROVE_DATE,
                CASE WHEN STATUS_APPROVE_STOCKOPNAME = 1 THEN 'Belum Disetujui'
                     WHEN STATUS_APPROVE_STOCKOPNAME = 2 THEN 'Disetujui'
                     WHEN STATUS_APPROVE_STOCKOPNAME = 5 THEN 'Belum Disetujui Closing'
                     WHEN STATUS_APPROVE_STOCKOPNAME = 6 THEN 'Disetujui Closing'
                END as STATUS_APPRO
                FROM STOCK_OPNAME
                WHERE ID_STOCKOPNAME = '$idtrans'";
        } 
    ...
    public function get_transaksi_prev($sloc,$bbm,$tgl,$no_trans){
        ...
        $query = "CALL GET_BACKDATE_TRANS_STOCKOPNAME('$sloc','$bbm','$tgl','$before');";
        $sql = $this->db->query($query);
    ...
    public function update_stockopname($sloc, $jenis,$bbm, $idtrans, $stockopname, $tgl, $status, $jnsrollback, $alasan, $approveby, $approvedate, $value, $rollafter) {
        ...
        $data1[0]['SLOC'] = $sloc;
        $data1[0]['JNS_TRANSAKSI'] = 'Stockopname';
        $data1[0]['ID_JNS_BHN_BKR'] = $bbm;
        $data1[0]['NO_STOCKOPNAME'] = $stockopname;
        ...
        $data1[1]['NO_STOCKOPNAME'] = $value[5];
        ...
        foreach ($rollafter as $key => $val) {
            ...
            $this->db->insert('LOG_ROLLBACK_STOCKOPNAME1', $data7);
        ...
        $this->db->insert_batch('LOG_ROLLBACK_STOCKOPNAME1', $data1);
        $this->db->update('STOCK_OPNAME', $data, $this->_key5($data2));
        $this->db->update('MUTASI_PEMAKAIAN', $data4, $this->_key($data5));
        $this->db->delete('KOMPONEN_HITUNG', $this->_key5($data2));
    ...
    public function update_stockopname_satu($sloc, $jenis,$bbm, $idtrans, $stockopname, $tgl, $status, $jnsrollback, $alasan, $approveby, $approvedate, $value, $rollafter) {
        $data['STATUS_APPROVE_STOCKOPNAME'] = 0;
        // $data['TGL_KIRIM'] = NULL;
    ...
    public function update_stockopname_dua($sloc, $jenis,$bbm, $idtrans, $stockopname, $tgl, $status, $jnsrollback, $alasan, $approveby, $approvedate, $rollafter) {
        $data['STATUS_APPROVE_STOCKOPNAME'] = 0;
        // $data['TGL_KIRIM'] = NULL;
        // $data['APPROVEL_BY_MUTASI_TERIMA'] = NULL;
        // $data['APPROVEL_DATE_MUTASI_TERIMA'] = NULL;
        ...
        $data1['SLOC'] = $sloc;
        $data1['JNS_TRANSAKSI'] = 'Stockopname';
        $data1['ID_JNS_BHN_BKR'] = $bbm;
        $data1['NO_STOCKOPNAME'] = $stockopname;
        ...
        $this->db->insert('LOG_ROLLBACK_STOCKOPNAME1', $data1);
        $this->db->update('STOCK_OPNAME', $data, $this->_key5($data2));
        $this->db->delete('KOMPONEN_HITUNG', $this->_key5($data2));
        $this->db->where('ID_JNS_BHN_BKR', $bbm);
        $this->db->where('TGL_MUTASI_PERSEDIAAN', $tgl);
    ...
    public function update_stockopname_tiga($sloc, $jenis,$bbm, $idtrans, $stockopname, $tgl, $status, $jnsrollback, $alasan, $approveby, $approvedate, $value, $rollafter) {
        $data['STATUS_APPROVE_STOCKOPNAME'] = 0;
        // $data['TGL_KIRIM'] = NULL;
        // $data['APPROVEL_BY_MUTASI_TERIMA'] = NULL;
        // $data['APPROVEL_DATE_MUTASI_TERIMA'] = NULL;
    ...
    public function delete_stockopname($sloc, $jenis,$bbm, $idtrans, $stockopname, $tgl, $status, $jnsrollback, $alasan, $value, $rollafter) {
        $data3 = $idtrans;
        $data4 = $value[0];
        $data5 = $sloc;
        $data6 = $value[2];
        ...
        $this->db->insert_batch('LOG_ROLLBACK_STOCKOPNAME1', $data1);
        $this->db->delete('STOCK_OPNAME', $this->_key5($data3));
        $this->db->update('MUTASI_PEMAKAIAN', $data2, $this->_key($data4));
        $this->db->delete('KOMPONEN_HITUNG', $this->_key5($data3));
    ...
    public function delete_stockopname_satu($sloc, $jenis,$bbm, $idtrans, $stockopname, $tgl, $status, $jnsrollback, $alasan, $value, $rollafter) {
        $data3 = $idtrans;
        $data4 = $value[0];
        $data5 = $sloc;
        $data6 = $value[2];
    ...
    public function delete_stockopname_dua($sloc, $jenis,$bbm, $idtrans, $stockopname, $tgl, $status, $jnsrollback, $alasan, $rollafter) {
        $data3 = $idtrans;
        $data5 = $sloc;
    ...
    public function delete_stockopname_tiga($sloc, $jenis,$bbm, $idtrans, $stockopname, $tgl, $status, $jnsrollback, $alasan, $value, $rollafter) {
        $data3 = $idtrans;
        $data4 = $value[0];
        $data5 = $sloc;
        $data6 = $value[2];
