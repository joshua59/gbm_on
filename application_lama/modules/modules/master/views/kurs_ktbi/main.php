        ...
        <div class="row-fluid">
            <div class="span12">
                <div class="well-content no-search">
                    ...
                    <label for="lb_sho" id="ref" title="Klik untuk membuka link Referensi data"><i>(*Referensi data : www.bi.go.id/id/moneter/informasi-kurs/transaksi-bi/Default.aspx)</i></label>
                    <div>&nbsp;</div>
                    <div>&nbsp;</div>
                </div>
    ...
    jQuery(function($) {
        ...
        $('#ref').click(function() {
            bootbox.confirm('Apakah yakin akan membuka link Referensi data ?', "Tidak", "Ya", function(e) {
              if(e){
                window.open('https://www.bi.go.id/id/moneter/informasi-kurs/transaksi-bi/Default.aspx', '_blank');
              }
            });
        });
        ...
        function get_kurs(){
            ...
            $.ajax({
                type: "POST",
                url : "<?php echo base_url('master/kurs_ktbi/get_ktbi'); ?>",
