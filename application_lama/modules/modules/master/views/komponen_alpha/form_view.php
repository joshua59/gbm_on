<div class="row-fluid">
    ...
    <div class="box-content">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo form_input('NO_PERJANJIAN', !empty($default->NO_PERJANJIAN) ? $default->NO_PERJANJIAN : '', 'class="span6" disabled'); ?>
            </div>
        </div>
        <div class="control-group">
            <label for="password" class="control-label">Nilai Konstanta MFO<span class="required">*</span> : </label>
            <div class="controls">
                <?php echo form_input('NILAI_KONSTANTA_MFO', !empty($default->NILAI_KONSTANTA_MFO) ? $default->NILAI_KONSTANTA_MFO : '', 'class="span6 rp" disabled'); ?>
            </div>
        </div>
        <div class="control-group">
            <label for="password" class="control-label">Nilai Konstanta HSD<span class="required">*</span> : </label>
            <div class="controls">
                <?php echo form_input('NILAI_KONSTANTA_HSD', !empty($default->NILAI_KONSTANTA_HSD) ? $default->NILAI_KONSTANTA_HSD : '', 'class="span6 rp" disabled'); ?>
            </div>
        </div>
        <div class="control-group">
            ...
            <div class="controls">
                ...
                <?php echo form_input('FK_MOPS', !empty($default->FK_MOPS) ? $default->FK_MOPS : '', 'class="span6 rp" disabled'); ?>
            </div>
        </div>
        <div class="control-group">
            <label for="password" class="control-label">Variabel Hitung <span class="required">*</span> : </label>
            <div class="controls">
                <?php echo form_input('VARIABEL_HITUNG', !empty($default->VARIABEL_HITUNG) ? $default->VARIABEL_HITUNG : '', 'class="span6 rp" disabled'); ?>
            </div>
        </div>
        <div class="control-group">
            <label for="password" class="control-label">Persentase Hitung<span class="required">*</span> : </label>
            <div class="controls">
                <?php echo form_input('PERSEN_HITUNG', !empty($default->PERSEN_HITUNG) ? $default->PERSEN_HITUNG : '', 'class="span2 rp_nol " disabled'); ?>  %
            </div>
        </div>
         ...
         <div class="control-group">
            ...
            <div class="controls">
                <?php echo form_input('TGL_AWAL', !empty($default->TGL_AWAL) ? $default->TGL_AWAL : '', 'class="span2 input-append date form_datetime" placeholder="Pilih Tanggal" disabled'); ?>
            </div>
        </div>
        <div class="control-group">
            <label for="password" class="control-label">Tanggal Akhir : <span class="required">*</span></label> 
            <div class="controls">
                <?php echo form_input('TGL_AKHIR', !empty($default->TGL_AKHIR) ? $default->TGL_AKHIR : '', 'class="span2 input-append date form_datetime" placeholder="Pilih Tanggal" disabled'); ?>
            </div>
        </div>
        <div class="control-group" hidden>
            <label for="password" class="control-label">Aktif : </label>
            <div class="controls">
            <?php echo form_checkbox('IS_AKTIF', '1', !empty($default->IS_AKTIF) ? $default->IS_AKTIF : '','disabled' ); ?>
            </div>
        </div>
