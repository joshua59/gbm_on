...
<div class="inner_content" id="divTop">
    ...
    <div class="widgets_area">
        ...
        <br>
        <div class="well-content no-search">
          <div id="container_grafik" style="height: 700px"></div>
        </div>
        <br>
...
<script type="text/javascript">
    ...
    function setGrafikAwal(resp){
        ...
        $.each(obj, function(index, value) {
            ...
            temp_do.name = value.NAMA_JNS_BHN_BKR;
            temp_real.name = value.NAMA_JNS_BHN_BKR;

            temp_do.y = parseInt(value.VOL_TERIMA);
            temp_real.y = parseInt(value.VOL_TERIMA_REAL);

            temp_do.color = 'rgba(255, 193, 7, 1)';
            temp_real.color = 'rgba(255, 193, 7, 0.5)';
    ...
    function getDetailTabel(vbbm,vawalParsed,vakhirParsed,vlvl0,vlevelid){
        $.ajax({
            type: "POST",
            data: {
                "jenis_bbm": vbbm,
            ...
            url : "<?php echo base_url('laporan/penerimaan_do_real/get_detail'); ?>",          
    ...
    function getGrafik() {
        ...
        if (tglAwal == '' && tglAkhir != '') {
          ...
          bootbox.alert('<div class="box-title" style="color:#ac193d;"><i class="icon-remove-sign"></i>  --Tanggal akhir tidak boleh kosong-- </div>', function() {});
            ...
            $.ajax({
                type: "POST",
                url : "<?php echo base_url('laporan/penerimaan_do_real/fetchData'); ?>",
                ...
                success:function(response) {
                    ...
                    getDetailTabel(bbm,awalParsed,akhirParsed,lvl0,vlevelid);
