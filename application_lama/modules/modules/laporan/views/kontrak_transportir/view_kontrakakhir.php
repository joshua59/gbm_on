...
<form id="export_excel" action="<?php echo base_url('laporan/kontrak_transportir/export_excel_adendum'); ?>" method="post">
...
<form id="export_pdf" action="<?php echo base_url('laporan/kontrak_transportir/export_pdf_adendum'); ?>" method="post" target="_blank">
        ...
        function get_data(){
            ...
            if (tglawal == '' && tglakhir != '') {
              ...
              bootbox.alert('<div class="box-title" style="color:#ac193d;"><i class="icon-remove-sign"></i>  --Tanggal akhir tidak boleh kosong-- </div>', function() {});
                ...
                $.ajax({
                    url: "<?php echo site_url('laporan/kontrak_transportir/ajax_list_adendum/')?>",
                    type: "POST",
                    data: {
                             "p_unit": p_unit,
