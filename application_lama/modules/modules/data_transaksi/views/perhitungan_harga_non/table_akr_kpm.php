    ...
    <div class="well-content no-search">
        ...
        foreach ($list as $list2) {
            foreach ($list2 as $data) {
                ...
                $no++;
                echo form_hidden('vidtrans_save_ke'.$no, !empty($data['idtrans']) ? $data['idtrans'] : '', 'id="vidtrans_save_ke'.$no.'" readonly');
...
<script type="text/javascript">
    ...
    function simpan_data_hitung() {
        if ($('#stat').val()=='add'){
            var urlna ="<?php echo base_url()?>data_transaksi/perhitungan_harga_non/simpan_data_all/";
        } else if ($('#stat').val()=='tambah_koreksi'){
            var urlna ="<?php echo base_url()?>data_transaksi/perhitungan_harga_non/simpan_data_all_koreksi/";
        } else {
            var urlna ="<?php echo base_url()?>data_transaksi/perhitungan_harga_non/simpan_data_all_edit/";
        }
