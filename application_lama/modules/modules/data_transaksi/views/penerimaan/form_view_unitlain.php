    ...
    <div class="box-content">
        ...
        echo form_open_multipart($form_action, array('id' => 'finput', 'class' => 'form-horizontal'), $hidden_form);
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <?php echo form_dropdown('COCODE_PEMASOK', $lv1_options_pemasok, !empty($default->COCODE) ? $default->COCODE : '', 'class="span6 chosen" id="COCODE_PEMASOK" disabled'); ?>
                </div>
            </div>
            <div class="control-group">
                <label  class="control-label">Level 2 Pemasok<span class="required">*</span> : </label>
                <div class="controls">
                    <?php echo form_dropdown('PLANT_PEMASOK', $lv2_options_pemasok, !empty($default->PLANT) ? $default->PLANT : '', 'class="span6 chosen" id="PLANT_PEMASOK"  disabled'); ?>
                </div>
            </div>
            <div class="control-group">
                <label  class="control-label">Level 3 Pemasok<span class="required">*</span> : </label>
                <div class="controls">
                    <?php echo form_dropdown('STORE_SLOC_PEMASOK', $lv3_options_pemasok, !empty($default->STORE_SLOC) ? $default->STORE_SLOC : '', 'class="span6 chosen" id="STORE_SLOC_PEMASOK"  disabled'); ?>
                </div>
            </div>
            <div class="control-group">
                <label  class="control-label">Pembangkit Pemasok<span class="required">*</span> : </label>
                <div class="controls">
                    <?php echo form_dropdown('SLOC_PEMASOK', $lv4_options_pemasok, !empty($default->SLOC) ? $default->SLOC : '', 'class="span6 chosen" id="pembangkit_pemasok" disabled'); ?>
                </div>
            </div>
