        ...
        <div class="row-fluid">
            <div class="span12">
                <div id ="index-content" class="well-content no-search">
                    ...
                    <div class="well">
                        ...
                        <?php echo form_open_multipart('', array('id' => 'ffilter')); ?>
                            ...
                            <div class="form_row">
                                ...
                                <div class="pull-left span3" id="filter_status">
                                    ...
                                    <div class="controls">
                                        ...
                                        <input type="hidden" name="hanya_kirim" id="hanya_kirim" value="">
                                    </div>
                                </div>
                            </div> 
                            <br>
                            ...
                            <div class="pull-left span8" id="label_sum">
                                <div class="controls">
                                        <table>
                                           <tr>
                    ...
                    <div id="content_table2" data-source="<?php echo $data_sources; ?>" data-filter="#ffilter"></div>
                    <div>&nbsp;</div>
                </div>
...
<script type="text/javascript">
    ...
    jQuery(function($) {
        var vnotif = '<?php echo $page_notif; ?>';
        var vnotif_status = '<?php echo $page_notif_status; ?>';        
        ...
        if (vnotif){
          ...
          $('select[name="STATUS"]').val(vnotif_status);

          $('#filter_status').hide();  
          $('#btn_add').hide();
          $('#label_sum').hide(); 
          $('#hanya_kirim').val(<?php echo '"'.$cd_by.'"'; ?>);
        }

        load_table('#content_table2', 1, '#ffilter');
        get_sum_detail();
