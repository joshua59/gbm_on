...
<?php
    if ($JENIS == 'XLS') {
        ...
        header('Content-Disposition: attachment; filename=Cetak_Form_Harga_BBM_KPM.xls');
...
<table border="0" style="width:100%;">
    ...
    <tr>
        ...
        <td style="text-align:justify">Harga BBM (HSD) Bulan <?php echo $periode;?> untuk <?php echo $arr_pltd;?></td>
        <td style="text-align:left"></td>
...
<table border="0" style="width:100%;">
    <tr>
        <td style="width:9%;text-align:left"></td>
        <td style="width:1%;text-align:center"></td>
        <td style="width:90%;text-align:justify">Sesuai dengan Perjanjian Jual Beli BBM (HSD) antara KPM dan PLN untuk <?php echo $list_unit[0]->LEVEL1;?> Repeat Order No. PLN <?php echo $val->NOPJBBM;?> yang berlaku efektif mulai tanggal <?php echo $tgl_awal_kontrak;?>. Bersama ini kami sampaikan Harga Pembelian BBM (HSD) untuk bulan <?php echo $periode;?> dari KPM sebagai berikut : 
        </td>
    </tr>    
</table>
<br>

<!-- <?php print_r($list_unit)?> -->
            ...
            <table style="width:100%;" class="tdetail">
                ...
                <!-- </thead>   -->
                    ...
                    <tr>
                        ...
                        <th style="width:40%;text-align:center">Pembangkit</th>
                        <th style="width:40%;text-align:center">Harga di Tangki Timbun PLN<br>(Rp/Liter)</th>
                    </tr>   
                <tbody>    
                    <?php
                        $i=1;
...
<!-- <?php echo "tgl kontrak = "; print_r($tgl_awal_kontrak);?> -->
    ...
    foreach ($list as $row) {
        ...
        <table border="0" style="width:100%;">  
            ...
            <tr>
                ...
                <td colspan="5" style="text-align:left"><b>Harga BBM (HSD) Dari PT Kutilang Paksi Mas ke Pembangkit '.$row['LEVEL4'].' Bulan '.$periode.'</b></td>
            </tr>    
            <tr>
                <td style="text-align:left"></td>
                <td style="text-align:center"></td>
                <td style="text-align:center">=</td>        
                <td style="text-align:center">('.number_format($row['ALPHA_HSD'], 2, ',', '.').' + (LOPS '.$param->MOPS_PERSEN.' * '.$param->PERSEN.')) * (1,1) * ('.$jns_kurs.')<hr style="margin:1px">'.$param->KONVERSI_BARREL.'</td>
                <td style="text-align:center">+</td>
                    ...
                    <table style="width:100%;" class="tdetail">  
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td style="text-align:left">'.number_format($row['ALPHA_HSD'], 2, ',', '.').' USD / Barrel</td>
                            </tr>
                            <tr>
                                ...
                                <td style="text-align:left">'.number_format($row['LOW_HSD_RATA2'], 2, ',', '.').' USD / Barrel ('.$tglawal_akhir.')</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td style="text-align:left">'.number_format($row['RATA2_KURS'], 2, ',', '.').' Rp / USD ('. $tglawal_akhir.')</td>
                            </tr>
                            <tr>
