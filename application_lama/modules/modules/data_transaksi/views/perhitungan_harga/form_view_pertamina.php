                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <span style="display:inline-block">
                                    ...
                                    <input type="text" name="ALPHA_HSD" class="form-control span4 rp" placeholder="Alpha" style="width: 80px" id="p_alphahsd" value="<?php echo !empty($default->ALPHA_HSD) ? $default->ALPHA_HSD : '0'?>" disabled>
                                </span>
                            </div>
                        </div>
                        <div class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <span style="display:inline-block">
                                    ...
                                    <input type="text" name="ALPHA_MFO" class="form-control span4 rp" placeholder="Alpha" style="width: 80px" id="p_alphamfo" step="0.1" min="0.1" required value="<?php echo !empty($default->ALPHA_MFO) ? $default->ALPHA_MFO : ''?>" disabled>
                                </span>
                            </div>
                        </div>
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <span style="display:inline-block">
                                    ...
                                    <input type="text" name="SULFURMFOLSFO" class="form-control span4 rp" placeholder="Sulfur" style="width: 80px" id="p_sulfurmfolsfo" value="<?php echo !empty($default->SULFUR_MFO_LSFO) ? $default->SULFUR_MFO_LSFO : '0'?>" disabled>%
                                </span>
                                <span style="display:inline-block">
                                    <label for="p_konversimfolsfo" style="display:block">Konversi (L)</label>
                                    <input type="text" name="KONVERSI_MFO_LSFO" class="form-control span4 des4" placeholder="Konversi" style="width: 80px" id="p_konversimfolsfo" value="<?php echo !empty($default->KONVERSI_MFO_LSFO) ? $default->KONVERSI_MFO_LSFO : '0'?>" disabled>
                                </span>
                                <!-- <span style="display:inline-block">
                                    <label for="KONSTANTA_MFO" style="display:block">Konstanta</label>
                                    <input type="text" name="KONSTANTA_MFO" class="form-control span4" placeholder="Konversi" style="width: 80px" id="KONSTANTA_MFO" value="<?php echo !empty($default->KONSTANTA_MFO) ? $default->KONSTANTA_MFO : '0'?>" disabled>
                                ...
                                <span style="display:inline-block">
                                    ...
                                    <input type="text" name="ALPHA_MFO_LSFO" class="form-control span4 rp" placeholder="Alpha" style="width: 80px" id="p_alphamfolsfo" step="0.1" min="0.1" required value="<?php echo !empty($default->ALPHA_MFO_LSFO) ? $default->ALPHA_MFO_LSFO : '0'?>" disabled>
                                </span>
                            </div>
                        </div>
                        <!-- <div class="control-group">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <span style="display:inline-block">
                                    ...
                                    <input type="text" name="PPN" class="form-control span4 " placeholder="PPN" style="width: 80px" id="PPN" value="<?php echo !empty($default->PPN) ? $default->PPN : '10'?>" disabled> %
                                </span>
                            </div>
                        </div>
                    </div>
