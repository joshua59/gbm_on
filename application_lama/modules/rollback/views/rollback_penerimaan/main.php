                            ...
                            ?>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        ...
                                        <?php echo form_hidden('NO_MUTASI_TERIMA', !empty($default->NO_MUTASI_TERIMA) ? $default->NO_MUTASI_TERIMA : '', 'class="span12" id="NO_MUTASI_TERIMA" readonly style="color : black"'); ?>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#btn-rollback').click(function(){
            ...
            var v_nomutasi = $('#NO_MUTASI_TERIMA').val();
            ...
            var vlink_url = '<?php echo base_url()?>rollback/rollback_penerimaan/rollback/';
            $.ajax({
                url: vlink_url,
                type: "POST",
                data : {
        ...
        $('#btn-hapus').click(function(){
            ...
            var vlink_url = '<?php echo base_url()?>rollback/rollback_penerimaan/delete/';
            $.ajax({
                url: vlink_url,
                type: "POST",
                data : {
        ...
        $('#btn-check').click(function(){
            ...
            if(v_jnsbbm == '' || v_sloc == '' || v_jenis == '' || v_nomortrans == '' || v_tglba == '' || v_status == '' ||v_jenisrollback == '' || v_alasan == ''){
                ...
                if(v_status == 'Disetujui' || v_status == 'Disetujui Closing') {
                    var link = '<?php echo base_url()?>rollback/rollback_penerimaan/get_transaksi_prev/';
                    var links = '<?php echo base_url()?>rollback/rollback_penerimaan/get_transaksi_prev_after/';
    ...
    function get_filter(v_sloc){
        var vurl = '<?php echo base_url()?>rollback/rollback_penerimaan/get_filter/';
        $.ajax({
            url: vurl,
            type: "POST",
            data : {
    ...
    function get_jenis_bbm(v_sloc){
        var vlink_url = '<?php echo base_url()?>rollback/rollback_penerimaan/load_jenisbbm/';
        $.ajax({
            url: vlink_url,
            type: "POST",
            data : {
    ...
    function get_all(v_sloc){
        var vlink_url = '<?php echo base_url()?>rollback/rollback_penerimaan/get_all/';
        $.ajax({
            url: vlink_url,
            type: "POST",
            data : {
    ...
    function get_transaksi(v_sloc,v_jenis,v_jnsbbm) {
        var vlink_url = '<?php echo base_url()?>rollback/rollback_penerimaan/get_transaksi/';
        $.ajax({
            url: vlink_url,
            type: "POST",
            data : {
    ...
    function get_detailtransaksi(v_idtrans,v_jenis) {
        ...
        var vlink_url = '<?php echo base_url()?>rollback/rollback_penerimaan/get_detailtransaksi/';
        $.ajax({
            url: vlink_url,
            type: "POST",
            data : {
            ...
            success:function(data) {
                ...
                $("#NO_MUTASI_TERIMA").val(obj.NO_MUTASI_TERIMA);
