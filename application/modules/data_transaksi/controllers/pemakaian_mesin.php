 ...
 *
 */
class pemakaian_mesin extends MX_Controller{
    private $_title = 'Mutasi Pemakaian Mesin';
    private $_limit = 10;
    private $_module = 'data_transaksi/pemakaian_mesin';
    ...
    public function __construct(){
        ...
        /* Load Global Model */
        $this->load->model('pemakaian_mesin_model', 'tbl_get');
    }
    ...
    public function add($id = ''){
        ...
        if ($id != '') {
            ...
            $data['option_jenis_mesin'] = $this->tbl_get->options_jenis_mesin();
            ...
            $data['option_jenis_mesin'][''] = '--Pilih Jenis Mesin--';//$this->tbl_get->options_jenis_mesin();
        }
		$data['urljnsbbm'] = base_url($this->_module) .'/load_jenisbbm';
        $data['urljnsmesin'] = base_url($this->_module) .'/load_jenismesin';
    ...
    public function load_jenismesin($idsloc = ''){
        $message = $this->tbl_get->options_jns_mesin('--Pilih Jenis Mesin--', $idsloc);
        echo json_encode($message);
    }
