...
<script type="text/javascript">
    ...
    function get_mops_kurs(id){ 
        ...
        var urlna ="<?php echo base_url()?>data_transaksi/perhitungan_harga_bbm_nr/get_mops_kurs_pertamina_edit/";
        if(id){
            bootbox.hideAll();
            bootbox.modal('<div class="loading-progress"></div>');
            $.ajax({
    ...
    function get_mops_kurs_akr_kpm(id,pembangkit,nopjbbbm,jns_kurs,kurs,mops,tglawal,skema){ 
        var data_kirim = 'vidtrans='+id+'&pembangkit='+pembangkit+'&nopjbbbm='+nopjbbbm;
        var urlna ="<?php echo base_url()?>data_transaksi/perhitungan_harga_bbm_nr/get_mops_kurs_akr_kpm_edit/";
        if(id){
            bootbox.hideAll();
            bootbox.modal('<div class="loading-progress"></div>');
            $.ajax({
    ...
    function get_hitung_harga(){ 
        ...
        var url = "<?php echo base_url()?>data_transaksi/perhitungan_harga_bbm_nr/get_hitung_harga_pertamina_edit/";
    ...
    function get_hitung_harga_akr_kpm(){ 
        ...
        var url = "<?php echo base_url()?>data_transaksi/perhitungan_harga_bbm_nr/get_hitung_harga_edit/";
...
<script type="text/javascript">
    ...
    $('select[name="ID_REGIONAL"]').on('change', function() {
        ...
        var vlink_url = '<?php echo base_url()?>data_transaksi/perhitungan_harga_bbm_nr/get_options_lv1/'+stateID;
        setDefaultLv1();
        setDefaultLv2();
        setDefaultLv3();
        setDefaultLv4();
    ...
    $('select[name="COCODE"]').on('change', function() {
        var stateID = $(this).val();
        var vlink_url = '<?php echo base_url()?>data_transaksi/perhitungan_harga_bbm_nr/get_options_lv2/'+stateID;
        setDefaultLv2();
        setDefaultLv3();
        setDefaultLv4();
        if(stateID) {
    ...
    $('select[name="PLANT"]').on('change', function() {
        var stateID = $(this).val();
        var vlink_url = '<?php echo base_url()?>data_transaksi/perhitungan_harga_bbm_nr/get_options_lv3/'+stateID;
        setDefaultLv3();
        setDefaultLv4();
        if(stateID) {
          bootbox.modal('<div class="loading-progress"></div>');
    ...
    $('select[name="STORE_SLOC"]').on('change', function() {
        var stateID = $(this).val();
        var vlink_url = '<?php echo base_url()?>data_transaksi/perhitungan_harga_bbm_nr/get_options_lv4/'+stateID;
        setDefaultLv4();
        if(stateID) {
          bootbox.modal('<div class="loading-progress"></div>');
          $.ajax({
