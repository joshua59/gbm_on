            ...
            <tbody>
                ...
                foreach ($list as $data) {
                    ...
                    echo "<td style='text-align:center'>
                            <a href='javascript:void(0);' class='btn transparant' id='".$data['IDTRANS']."' onclick='open_mops(this.id)' vnp_pjbbbm='".$data['NOPJBBM']."' pembangkit='".$data['LEVEL4']."' jns_kurs='".$data['JNS_KURS']."' kurs='".$kurs."' mops='".$mops."'><i class='icon-zoom-in' title='Lihat Mops dan Kurs'></i></a> 
                    </td>";
                    echo "</tr>";
                }
...
<script type="text/javascript">
    ...
    function open_mops(vid) {
        ...
        get_mops_kurs_akr_kpm(vid,pembangkit,nopjbbbm,jns_kurs,kurs,mops);
    }
