            ...
            <br><br>     
                ...
                <div class="row">
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <?php echo form_input('periode', !empty($default->PERIODE) ? $default->PERIODE : '', 'class="span10 cek_edit_cmb" placeholder="Pilih Periode Perhitungan" id="periode"'); ?>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <?php echo form_input('tglawal', !empty($default->TGLAWAL) ? $default->TGLAWAL : '', 'class="form_datetime cek_edit_cmb" placeholder="Dari Tanggal" id="tglawal" style="width: 126px" '); ?>
                            <label for="">s/d</label>
                            <?php echo form_input('tglakhir', !empty($default->TGLAKHIR) ? $default->TGLAKHIR : '', 'class="form_datetime cek_edit_cmb" placeholder="Sampai Tanggal" id="tglakhir" style="width: 126px" '); ?>
                        </div>
                    </div>
                    <div class="control-group">
                    ...
                    <div class="pertamina" style="display:none">
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <span style="display:inline-block">
                                    ...
                                    <input type="text" name="SULFUR_HSD" class="form-control span4 rp cek_edit" placeholder="Sulfur" style="width: 80px" id="p_sulfurhsd" step="0.1" min="0.1" required value="<?php echo !empty($default->SULFUR_HSD) ? $default->SULFUR_HSD : '100'?>">%
                                </span>
                                <span style="display:inline-block">
                                ...
                                <span style="display:inline-block">
                                    <label for="p_alphahsd" style="display:block">Alpha</label>
                                    <input type="text" name="ALPHA_HSD" class="form-control span4 des4 cek_edit" placeholder="Alpha" style="width: 80px" id="p_alphahsd" step="0.1" min="0.1" required value="<?php echo !empty($default->ALPHA_HSD) ? $default->ALPHA_HSD : ''?>">
                                </span>
                                <!-- <span style="display:inline-block">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <span style="display:inline-block">
                                    ...
                                    <input type="text" name="SULFURMFO" class="form-control span4 rp cek_edit" placeholder="Sulfur" style="width: 80px" id="p_sulfurmfo" required value="<?php echo !empty($default->SULFUR_MFO) ? $default->SULFUR_MFO : '100'?>">%
                                </span>
                                <span style="display:inline-block">
                                ...
                                <span style="display:inline-block">
                                    <label for="p_alphamfo" style="display:block">Alpha</label>
                                    <input type="text" name="ALPHA_MFO" class="form-control span4 des4 cek_edit" placeholder="Alpha" style="width: 80px" id="p_alphamfo" step="0.1" min="0.1" required value="<?php echo !empty($default->ALPHA_MFO) ? $default->ALPHA_MFO : ''?>">
                                </span>
                                <!-- <span style="display:inline-block">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <span style="display:inline-block">
                                    <label for="p_sulfurmfolsfo" style="display:block">Sulfur</label>
                                    <input type="text" name="SULFURMFOLSFO" class="form-control span4 rp cek_edit" placeholder="Sulfur" style="width: 80px" id="p_sulfurmfolsfo" required value="<?php echo !empty($default->SULFUR_MFO_LSFO) ? $default->SULFUR_MFO_LSFO : '100'?>">%
                                </span>
                                <span style="display:inline-block">
                                    <label for="p_konversimfolsfo" style="display:block">Konversi (L)</label>
                                    <input type="text" name="KONVERSI_MFO_LSFO" class="form-control span4 des4 cek_edit" placeholder="Konversi" style="width: 80px" id="p_konversimfolsfo" required value="<?php echo !empty($default->KONVERSI_MFO_LSFO) ? $default->KONVERSI_MFO_LSFO : '0'?>">
                                </span>
                                <span style="display:inline-block">
                                    <label for="p_alphamfolsfo" style="display:block">Alpha</label>
                                    <input type="text" name="ALPHA_MFO_LSFO" class="form-control span4 des4 cek_edit" placeholder="Alpha" style="width: 80px" id="p_alphamfolsfo" step="0.1" min="0.1" required value="<?php echo !empty($default->ALPHA_MFO_LSFO) ? $default->ALPHA_MFO_LSFO : '0'?>">
                                </span>
                                <!-- <span style="display:inline-block">
                                    <label for="KONSTANTA_MFO" style="display:block">Konstanta</label>
                                    <input type="text" name="KONSTANTA_MFO" class="form-control span4" placeholder="Konversi" style="width: 80px" id="KONSTANTA_MFO" value="<?php echo !empty($KONSTANTA_MFO) ? $KONSTANTA_MFO : '0'?>" disabled>
                        ...
                        <div class="control-group">
                            <label for="password" class="control-label">PPN<span class="required">*</span> : </label>
                            <div class="controls">
                                <!-- <span style="display:inline-block">
                                ...
                                <span style="display:inline-block">
                                    <label for="PPN" style="display:block"></label>
                                    <input type="text" name="PPN" class="form-control span4 " placeholder="PPN" style="width: 80px" id="PPN" value="<?php echo !empty($default->PPN) ? $default->PPN : '10'?>"> %
                                </span>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    function formula_pertamina(){ 
        ...
        var urlna="<?=base_url()?>data_transaksi/perhitungan_harga/formula_pertamina/";
    ...
    function get_mops_kurs(id){ 
        ...
        var urlna ="<?php echo base_url()?>data_transaksi/perhitungan_harga/get_mops_kurs/";
        if(id){
            bootbox.hideAll();
            bootbox.modal('<div class="loading-progress"></div>');
            $.ajax({
    ...
    function get_hitung_harga(){ 
        var data_kirim = {
            ...
            alpha_hsd: $('#p_alphahsd').val(),
            alpha_mfo: $('#p_alphamfo').val(),
            alpha_mfo_lsfo: $('#p_alphamfolsfo').val(),
            sulfur_hsd: $('#p_sulfurhsd').val(),
            sulfur_mfo: $('#p_sulfurmfo').val(),
            sulfur_mfo_lsfo: $('#p_sulfurmfolsfo').val(),
            konversi_hsd: $('#p_konversihsd').val(),
            konversi_mfo: $('#p_konversimfo').val(),
            konversi_mfo_lsfo: $('#p_konversimfolsfo').val(),
            ppn: $('#PPN').val(),
        ...
        var url = "<?php echo base_url()?>data_transaksi/perhitungan_harga/get_hitung_harga/";
    ...
    function get_hitung_harga_ulang(){ 
        ...
        var url = "<?php echo base_url()?>data_transaksi/perhitungan_harga/get_hitung_harga_pertamina_ulang/";
    ...
    function get_mops_kurs_edit(id){ 
        var data_kirim = 'vidtrans='+id;
        var urlna ="<?php echo base_url()?>data_transaksi/perhitungan_harga/get_mops_kurs_pertamina_edit/";
        if(id){
            bootbox.hideAll();
            bootbox.modal('<div class="loading-progress"></div>');
            $.ajax({
    ...
    function get_mops_kurs_ulang(id){ 
        var data_kirim = 'vidtrans='+id;
        var urlna ="<?php echo base_url()?>data_transaksi/perhitungan_harga/get_mops_kurs_pertamina_ulang/";
        if(id){
            bootbox.hideAll();
            bootbox.modal('<div class="loading-progress"></div>');
            $.ajax({
    ...
    function get_hitung_harga_edit(){ 
        ...
        var url = "<?php echo base_url()?>data_transaksi/perhitungan_harga/get_hitung_harga_pertamina_edit/";
        ...
        bootbox.confirm('Apakah yakin akan menyimpan data ?', "Tidak", "Ya", function(e) {
            if(e){
                ...
                if ($('input[name="id"]').val()){ //edit
                    if ($('#stat').val()=='tambah_koreksi'){
                        var urlna ="<?php echo base_url()?>data_transaksi/perhitungan_harga/simpan_data_koreksi/";
                    } else {
                        var urlna ="<?php echo base_url()?>data_transaksi/perhitungan_harga/simpan_data_edit/";
                    }
                } else { //add
                    var urlna ="<?php echo base_url()?>data_transaksi/perhitungan_harga/simpan_data/";
                }
