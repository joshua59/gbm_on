    ...
    <div class="box-content">
        ...
        echo form_open_multipart($form_action, array('id' => 'finput', 'class' => 'form-horizontal'), $hidden_form);
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <?php echo form_input('periode', !empty($default->TGLAWAL) ? $default->TGLAWAL : '', 'class="span4" placeholder="Pilih Tanggal Bill of Ladding" id="periode" readonly'); ?>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <?php echo form_dropdown('CMB_SKEMA_ISIDENTIL', $jns_isidentil_options, !empty($default->SKEMA_ISIDENTIL) ? $default->SKEMA_ISIDENTIL : '', 'class="span2" id="CMB_SKEMA_ISIDENTIL" disabled'); ?>
                    <?php echo form_hidden('SKEMA_ISIDENTIL', !empty($default->SKEMA_ISIDENTIL) ? $default->SKEMA_ISIDENTIL : '', 'class="span2" placeholder="Skema Insidentil" id="SKEMA_ISIDENTIL"'); ?>
                </div>
            </div>  
