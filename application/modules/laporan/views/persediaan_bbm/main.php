...
<div class="inner_content" id="divTop">
    ...
    <div class="widgets_area">
        ...
        <div class="well-content no-search" id="divTable">
            ...
            <br>            
            <label for="lb_sho"><i>(* HOP : Hari Operasi Pembangkit)</i></label><br>
            ...
            <label for="lb_cut_off"><i><img src="<?php echo base_url();?>assets/img/cut_off.png" style="width:25px;height:15px;">  : Perubahan jenis bbm</i></label></i></label>
...
<form id="export_pdf" action="<?php echo base_url('laporan/persediaan_bbm/export_pdf'); ?>" method="post" target="_blank">
            ...
            table = $('#dataTable').DataTable({
                ...
                "ajax": {
                    ...
                    "error": function (xhr, error, thrown) {
                        ...
                        msgGagal('Gagal get data persediaan bbm');
                    },                             
                },
                "columnDefs": [
                ...
                "fnRowCallback": function( nRow, aData, iDisplayIndex, iDisplayIndexFull ) {
                    if ( aData[20] == "1" ){
                        $('td', nRow).css('background-color', 'moccasin');
                    }
                }
            });
