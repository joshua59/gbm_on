    ...
    <div class="box-content">
        ...
        ?>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <?php echo form_input('JML_PASOKAN', !empty($default->JML_PASOKAN) ? $default->JML_PASOKAN : '', 'class="span2", id="JML_KIRIM", placeholder="Max 30" disabled'); ?>
                </div>
            </div>
            <br>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <?php echo form_dropdown('ID_DENDA', $option_denda, !empty($default->ID_DENDA) ? $default->ID_DENDA : '', 'class="span6" id="ID_DENDA" disabled'); ?>
                </div>
            </div>     
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <?php echo form_input('LOSSES', !empty($default->LOSSES) ? $default->LOSSES : '', 'class="span3" placeholder="Ketik Toleransi Losses" disabled'); ?>
                    <sup>%</sup>
                </div>
            </div>                    
            <div class="control-group">
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $("#addButton").click(function () {
            ...
            var combo_depo_transit ="<select class='form-control chosen cls_depo_transit' id='depotransit_ke"+ counter + "' name='depotransit_ke"+ counter + "' disabled>"+
            ...
            var text_jarak="<input type='text' id='jarak_ke"+ counter + "' name='jarak_ke"+ counter + "' placeholder='Jarak (KM aau ML)' size='35' disabled>";
    ...
    $('input[name=LOSSES]').inputmask("numeric", {radixPoint: ",",groupSeparator: ".",digits: 2,autoGroup: true,prefix: '',rightAlign: false, allowMinus: false,oncleared: function () { self.Value(''); }
    });    
