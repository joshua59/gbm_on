...
<div class="box-content">
    ...
    ?>
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo form_dropdown('ID_TRANSPORTIR_VIEW', $option_transportir, !empty($default->ID_TRANSPORTIR) ? $default->ID_TRANSPORTIR : '', 'class="span6 chosen" disabled'); ?>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo form_input('NO_KONTRAK', !empty($default->KD_KONTRAK_TRANSS) ? $default->KD_KONTRAK_TRANSS : '', 'class="span6" placeholder="Ketik No Adendum (Max 200)" id="NO_KONTRAK"'); ?>
        ...
        <div class="controls">
            ...
            <?php
                $data = array(
                  'name'        => 'KETERANGAN',
                  'id'          => 'KETERANGAN',
                  'value'       => !empty($default->KET_KONTRAK_TRANSS) ? $default->KET_KONTRAK_TRANSS : '',
                  'rows'        => '4',
                  'cols'        => '10',
                  'class'       => 'span6',
