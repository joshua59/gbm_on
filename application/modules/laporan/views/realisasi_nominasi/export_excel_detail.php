...
<?php
    if ($JENIS == 'XLS') {
        ...
        header('Content-Disposition: attachment; filename=Detail_Laporan_Realisaasi_Nominasi_BBM.xls');
...
<table border="0" style="width:100%;">
    <tr>
        ...
        <td style="width:80%;text-align:center" colspan="8"><h3>DETAIL LAPORAN REALISASI NOMINASI BBM</h3></td>
...
<table class="tdetail">
    ...
    <tr>
      ...
      ?>
        ...
        <td style="text-align:right;"><?php echo $b . ' ' . $tahun ?></td>
