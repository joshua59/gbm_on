...
<?php
    if ($JENIS == 'XLS') {
        ...
        header('Content-Disposition: attachment; filename=Laporan_Penerimaan_Pemasok.xls');
...
<table border="0" style="width:100%;">
    <tr>
        ...
        <td style="width:80%;text-align:center" colspan="8"><div class="box-kop">LAPORAN PENERIMAAN PER PEMASOK</div></td>
...
<table class="tdetail">
    ...
    <tr>
      <?php
          ...
          $JUMLAH_PASOKAN = !empty($row->JUMLAH_PASOKAN) ? number_format($row->JUMLAH_PASOKAN, 0, ',', '.') : '0';
      ...
      ?>
        ...
        <td style="text-align:right;"><?php echo $JUMLAH_PASOKAN ?></td>        
