...
,PK2.PEMAKAIAN_KIRIM,PN2.TERIMA_PEMASOK,PN3.TERIMA_PENGEMBALIAN,PN1.TERIMA_UNITLAIN,
A.DEAD_STOCK,A.VOLUME_STOCKOPNAME,A.STOCK_AKHIR_REAL,A.STOCK_AKHIR_EFEKTIF,A.STOCK_AKHIR_KOREKSI,
ROUND(A.SHO, 2) SHO,A.REVISI_MUTASI_PERSEDIAAN, H.STOCKEFEKTIF_TANGKI, H.VOLUME_TANGKI, H.VOLUME_TANGKI,SUM((H.VOLUME_TANGKI-A.STOCK_AKHIR_REAL)/H.VOLUME_TANGKI*100) ULLAGE,
...
ORDER BY D.THBL_MAX_PAKAI DESC LIMIT 1) ELSE (
SELECT
VOLUME_MAX_PAKAI
FROM
    MAX_PEMAKAIAN D 
WHERE
    DATE_FORMAT(D.CD_GENERATE,'%Y-%m-%d') <= DATE_FORMAT ( A.CD_DATE_MUTASI_PERSEDIAAN, '%Y-%m-%d' )
    AND D.SLOC = A.SLOC 
    AND D.ID_JNS_BHN_BKR = A.ID_JNS_BHN_BKR 
ORDER BY
    D.THBL_MAX_PAKAI DESC 
    LIMIT 1
) END MAX_PEMAKAIAN
FROM (
...
LEFT OUTER JOIN
(
SELECT SLOC,ID_JNS_BHN_BKR,TGL_PENGAKUAN,SUM(VOL_TERIMA_REAL) TERIMA_UNITLAIN FROM MUTASI_PENERIMAAN_APPROVE
...
LEFT OUTER JOIN
(
SELECT SLOC,ID_JNS_BHN_BKR,TGL_PENGAKUAN,SUM(VOL_TERIMA_REAL) TERIMA_PEMASOK FROM MUTASI_PENERIMAAN_APPROVE
...
LEFT OUTER JOIN
(
SELECT SLOC,ID_JNS_BHN_BKR,TGL_PENGAKUAN,SUM(VOL_TERIMA_REAL) TERIMA_PENGEMBALIAN FROM MUTASI_PENERIMAAN_APPROVE
WHERE STATUS_MUTASI_TERIMA IN ('2','6') AND JNS_PENERIMAAN='3' AND TGL_PENGAKUAN $SETTGL GROUP BY SLOC,ID_JNS_BHN_BKR,TGL_PENGAKUAN) PN3
ON PN3.SLOC = A.SLOC AND PN3.ID_JNS_BHN_BKR=A.ID_JNS_BHN_BKR AND PN3.TGL_PENGAKUAN=A.TGL_MUTASI_PERSEDIAAN
LEFT OUTER JOIN
(
SELECT SLOC,ID_JNS_BHN_BKR,TGL_MUTASI_PENGAKUAN,SUM(VOLUME_PEMAKAIAN) PEMAKAIAN_SENDIRI FROM MUTASI_PEMAKAIAN_APPROVE
...
LEFT OUTER JOIN
(
SELECT SLOC,ID_JNS_BHN_BKR,TGL_MUTASI_PENGAKUAN,SUM(VOLUME_PEMAKAIAN) PEMAKAIAN_KIRIM FROM MUTASI_PEMAKAIAN_APPROVE
...
INNER JOIN MASTER_TANGKI H ON A.SLOC=H.SLOC AND H.IS_AKTIF_TANGKI='1' AND A.ID_JNS_BHN_BKR=H.ID_JNS_BHN_BKR
...
,PK2.PEMAKAIAN_KIRIM,PN2.TERIMA_PEMASOK,PN3.TERIMA_PENGEMBALIAN,PN1.TERIMA_UNITLAIN,
A.DEAD_STOCK,A.VOLUME_STOCKOPNAME,A.STOCK_AKHIR_REAL,A.STOCK_AKHIR_EFEKTIF,A.STOCK_AKHIR_KOREKSI,
ROUND(A.SHO, 2) SHO,A.REVISI_MUTASI_PERSEDIAAN, A.ID_MUTASI_PERSEDIAAN, H.STOCKEFEKTIF_TANGKI, H.VOLUME_TANGKI,SUM((H.VOLUME_TANGKI-A.STOCK_AKHIR_REAL)/H.VOLUME_TANGKI*100) ULLAGE,
CASE WHEN MP.VOLUME_MAX_PAKAI IS NULL
THEN (  SELECT VOLUME_MAX_PAKAI
   FROM MAX_PEMAKAIAN D
 WHERE D.THBL_MAX_PAKAI < DATE_FORMAT (A.TGL_MUTASI_PERSEDIAAN,'%Y%m') - 1
...
A.DEAD_STOCK,A.VOLUME_STOCKOPNAME,
A.STOCK_AKHIR_REAL,A.STOCK_AKHIR_EFEKTIF,A.STOCK_AKHIR_KOREKSI,A.SHO,A.REVISI_MUTASI_PERSEDIAAN
ORDER BY A.TGL_MUTASI_PERSEDIAAN DESC, LEVEL0 ASC, LEVEL1 ASC, LEVEL2 ASC, LEVEL3 ASC, LEVEL4 ASC ";     
...
,PK2.PEMAKAIAN_KIRIM,PN2.TERIMA_PEMASOK,PN3.TERIMA_PENGEMBALIAN,PN1.TERIMA_UNITLAIN,
A.DEAD_STOCK,A.VOLUME_STOCKOPNAME,A.STOCK_AKHIR_REAL,A.STOCK_AKHIR_EFEKTIF,A.STOCK_AKHIR_KOREKSI,
ROUND(A.SHO, 2) SHO,A.REVISI_MUTASI_PERSEDIAAN, A.ID_MUTASI_PERSEDIAAN,
CASE WHEN MP.VOLUME_MAX_PAKAI IS NULL
THEN (  SELECT VOLUME_MAX_PAKAI
   FROM MAX_PEMAKAIAN D
 WHERE D.THBL_MAX_PAKAI < DATE_FORMAT (A.TGL_MUTASI_PERSEDIAAN,'%Y%m') - 1
