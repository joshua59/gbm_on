...
class kurs extends MX_Controller {
    ...
    public function index() {
        ...
        if ($this->laccess->otoritas('add')) {
            $data['button_group'] = array(
                ...
                anchor(null, '<i class="icon-cloud-download"></i> Get Kurs BI (JISDOR)', array('class' => 'btn green', 'id' => 'button-get-kurs'))
            );
        }
    ...
    public function proses() {
        ...
        if ($this->form_validation->run($this)) {
            ...
            $data = array();
            // $data['ID_KURS'] = $this->tbl_get->generate_id_kurs();
    ...
    public function load($page = 1) {
        ...
        $table->align = array('ID_KURS' => 'center', 'TGL_KURS' => 'center', 'KTBI' => 'center', 'UPDATE_KTBI' => 'center', 'CD_BY_KURS' => 'center', 'aksi' => 'center');
        $table->page = $page;
