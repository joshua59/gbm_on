...
class tangki_model extends CI_Model {
	...
	public function call_edit_tangki($p_sloc, $p_idtangki, $p_iddettangki, $p_nmtangki, $p_idbbm, $p_teraby, $p_path, $p_tglawal, $p_tglakhir, $p_volume, $p_deadstock, $p_stockefektif, $p_user, $p_aktif, $p_tangki){

        $q = "call EDIT_TANGKI('".$p_sloc."', '".$p_idtangki."', '".$p_iddettangki."', '".$p_nmtangki."', '".$p_idbbm."', '".$p_teraby."', '".$p_path."', '".$p_tglawal."', '".$p_tglakhir."', '".$p_volume."', '".$p_deadstock."', '".$p_stockefektif."', '".$p_user."', '".$p_aktif."', '".$p_tangki."')";
