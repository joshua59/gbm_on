...
class sho_bbm extends MX_Controller
{
  private $_title = 'Hari Operasi Pembangkit (HOP)';
  private $_limit = 10;
  private $_module = 'dashboard/sho';
...
public function get_grafik(){
    ...
    $data = $this->sho->mget_grafik($data);
...
public function getDataHsdBio()
{
    ...
    $data = $this->sho->getVolHsdBio($data);
    echo json_encode($data);
}
