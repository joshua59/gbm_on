 ...
 */
class stock_bbm_model extends CI_Model {
    ...
    public function getStockbbmHsd($data){
        $bulan = $data['BULAN'];
        $tahun = $data['TAHUN'];
        $vlevel = $data['VLEVEL'];
        $vlevelid = $data['VLEVELID'];

        $sql = "CALL lap_stock_bbm ('HSD', '$bulan', '$tahun', '$vlevel','$vlevelid')";
        $query = $this->db->query($sql);
            
        return $query->result();
    }

    public function getStockbbmMfo($data){
        $bulan = $data['BULAN'];
        $tahun = $data['TAHUN'];
        $vlevel = $data['VLEVEL'];
        $vlevelid = $data['VLEVELID'];

        $sql = "CALL lap_stock_bbm ('MFO', '$bulan', '$tahun', '$vlevel', '$vlevelid')";
        $query = $this->db->query($sql);
            
        return $query->result();
    }

    public function getStockbbmBio($data){
        $bulan = $data['BULAN'];
        $tahun = $data['TAHUN'];
        $vlevel = $data['VLEVEL'];
        $vlevelid = $data['VLEVELID'];

        $sql = "CALL lap_stock_bbm ('BIO', '$bulan', '$tahun', '$vlevel','$vlevelid')";
        $query = $this->db->query($sql);
            
        return $query->result();
    }

    public function getStockbbmHSDBIO($data){
        $bulan = $data['BULAN'];
        $tahun = $data['TAHUN'];
        $vlevel = $data['VLEVEL'];
        $vlevelid = $data['VLEVELID'];

        $sql = "CALL lap_stock_bbm ('HSD+BIO', '$bulan', '$tahun', '$vlevel','$vlevelid')";
        $query = $this->db->query($sql);
            
        return $query->result();
    }

    public function getStockbbmIDO($data){
        $bulan = $data['BULAN'];
        $tahun = $data['TAHUN'];
        $vlevel = $data['VLEVEL'];
        $vlevelid = $data['VLEVELID'];

        $sql = "CALL lap_stock_bbm ('IDO', '$bulan', '$tahun', '$vlevel','$vlevelid')";
        $query = $this->db->query($sql);
    ...
    public function getStockbbmHsdTahun($data){
        $bulan = $data['BULAN'];
        $tahun = $data['TAHUN'];
        $vlevel = $data['VLEVEL'];
        $vlevelid = $data['VLEVELID'];

        $sql = "CALL lap_stock_bbm_tahun('HSD', '$bulan', '$tahun', '$vlevel','$vlevelid')";
        $query = $this->db->query($sql);
            
        return $query->result();
    }

    public function getStockbbmMfoTahun($data){
        $bulan = $data['BULAN'];
        $tahun = $data['TAHUN'];
        $vlevel = $data['VLEVEL'];
        $vlevelid = $data['VLEVELID'];

        $sql = "CALL lap_stock_bbm_tahun ('MFO', '$bulan', '$tahun', '$vlevel', '$vlevelid')";
        $query = $this->db->query($sql);
            
        return $query->result();
    }

    public function getStockbbmBioTahun($data){
        $bulan = $data['BULAN'];
        $tahun = $data['TAHUN'];
        $vlevel = $data['VLEVEL'];
        $vlevelid = $data['VLEVELID'];
    ...
    public function getStockbbmHSDBIOTahun($data){
        $bulan = $data['BULAN'];
        $tahun = $data['TAHUN'];
        $vlevel = $data['VLEVEL'];
        $vlevelid = $data['VLEVELID'];

        $sql = "CALL lap_stock_bbm_tahun ('HSD+BIO', '$bulan', '$tahun', '$vlevel','$vlevelid')";
        $query = $this->db->query($sql);
            
        return $query->result();
    }

    public function getStockbbmIDOTahun($data){
        $bulan = $data['BULAN'];
        $tahun = $data['TAHUN'];
        $vlevel = $data['VLEVEL'];
        $vlevelid = $data['VLEVELID'];

        $sql = "CALL lap_stock_bbm_tahun ('IDO', '$bulan', '$tahun', '$vlevel','$vlevelid')";
        $query = $this->db->query($sql);
            
        return $query->result();
    }

    public function getStockSum($data){
        $jenis_bbm = $data['JENIS_BBM'];
        $thbl = $data['THBL'];
        $vlevel = $data['VLEVEL'];
        $vlevelid = $data['VLEVELID'];

        $sql = "CALL GET_SUM_STOCK ('$jenis_bbm', '$thbl', '$vlevel','$vlevelid')";
        $query = $this->db->query($sql);
