...
class grafik_model extends CI_Model {
    ...
    public function report(){
     ...
     public function getTableHsd_All($data)
     {
       $BULAN = $data['BULAN'];
       $TAHUN = $data['TAHUN'];
       $sql="CALL dashboard ('HSD','$BULAN','$TAHUN','All','')";
       $query = $this->db->query($sql);

       return $query->result();
     }
     public function getTableMfo_All($data)
     {
       $BULAN = $data['BULAN'];
       $TAHUN = $data['TAHUN'];
       $sql="CALL dashboard ('MFO','$BULAN','$TAHUN','All','')";
       $query = $this->db->query($sql);

       return $query->result();
     }

     public function getTableIdo_All($data)
     {
       $BULAN = $data['BULAN'];
       $TAHUN = $data['TAHUN'];
       $sql="CALL dashboard ('IDO','$BULAN','$TAHUN','All','')";
       $query = $this->db->query($sql);

       return $query->result();
     }
     public function getTableBio_All($data)
     {
       $BULAN = $data['BULAN'];
       $TAHUN = $data['TAHUN'];
       $sql="CALL dashboard ('BIO','$BULAN','$TAHUN','All','')";
       $query = $this->db->query($sql);

       return $query->result();
     }
     public function getTableHsdBio_All($data)
     {
       $BULAN = $data['BULAN'];
       $TAHUN = $data['TAHUN'];
       $sql="CALL dashboard ('HSD+BIO','$BULAN','$TAHUN','All','')";
       $query = $this->db->query($sql);
