                ...
                <div class="well-content clearfix" id="divTable">
					...
					<thead>
						<tr>
    						...
    						<th rowspan="2" style="text-align:center;">HOP (Hari)</td>
						</tr>
                        <tr>
                   ...
                   <label for="sho_detail"><i>(* HOP : Hari Operasi Pembangkit)</i></label></br>
                   <label for="sho_detail"><i>(* Hari Operasi Pembangkit (Hari) : untuk pembangkit selain PLTU)</i></label></br>
                   <label for="sho_detail"><i>(* Hari Operasi Pembangkit (kali start) : untuk pembangkit PLTU)</i></label></br>
