                ...
                <div class="well-content no-search" id="div_peta">
					...
					<table>
						<tr>
							...
							<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
							<td><label><i><img src="<?php echo base_url();?>assets/img/pltd2_merah.png" style="width:15px;height:15px;"></i> Unit <small id="merah"> 0 </small></label></td>
							<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
							<td><label><i><img src="<?php echo base_url();?>assets/img/pltd2_kuning.png" style="width:15px;height:15px;"></i> Unit <small id="kuning"> 0 </small></label></td>
							<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
							<td><label><i><img src="<?php echo base_url();?>assets/img/pltd2.png" style="width:15px;height:15px;"></i> Unit <small id="hijau"> 0 </small></label></td>
							<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
							<td><label><i><img src="<?php echo base_url();?>assets/img/pltd2_biru.png" style="width:15px;height:15px;"></i> Unit <small id="biru"> 0 </small></label></td>
							<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
							<td><label>Total : <small id="total"> 0 </small></label></td>
						</tr>
					</table>
					<br>
		    ...
		    success:function(data) {
									    ...
									    dataType:'json',
									        ...
									        success: function(data) {
									            ...
									            $.each(data, function(key, value) {
													...
													// var from_day = value.FROM_DAY_RED;
													// console.log(from_day);
													if (_SHO_MIN <=value.FROM_DAY_RED.slice(2)){
														icon_depo = pltd2_merah;
													} else if (_SHO_MIN <=value.FROM_DAY_YELLOW.slice(2)){
														icon_depo = pltd2_kuning;
													} else if(_SHO_MIN <=value.FROM_DAY_GREEN.slice(2)){
														icon_depo = pltd2;
													} else {
														biru++;
														icon_depo = pltd2_biru;
				...
				$.each(pembangkit, function(key, value) {
		        	...
		        	if ((value.LAT_LVL4)&&(value.LOT_LVL4)){ 			        	
						...
						var pltd_SHO = '';
						// var from_day_red = value.FROM_DAY_RED;
						var key_day = pembangkit[key].FROM_DAY_RED.slice(2);
						// var get = from_day_red[from_day_red.length-1];
						
						console.log('from_day_red: '+key_day);

						
						// if (_SHO_MIN <= from_day_red){
				...
				$('#biru').text('0')
				$('#total').text('0')
				$('#merah').text(merah+' ('+persen_merah+'%)')
				$('#kuning').text(kuning+' ('+persen_kuning+'%)')
				$('#hijau').text(hijau+' ('+persen_hijau+'%)')
				$('#biru').text(biru+' ('+persen_biru+'%)')
				$('#total').text(total_pembangkit)
		    }
		});
