				...
				<div class="well-content no-search" id="div_peta">
					...
					<table>
						<tr>
							...
							<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
							<td><label><i><img src="<?php echo base_url(); ?>assets/img/pltd2_merah.png" style="width:15px;height:15px;"> - Pembangkit (HOP <span id="param_red"></span> hari)</i></label></td>
							<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
							<td><label><i><img src="<?php echo base_url(); ?>assets/img/pltd2_kuning.png" style="width:15px;height:15px;"> - Pembangkit (HOP <span id="param_yellow"></span> hari)</i></label></td>
							<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
							<td><label><i><img src="<?php echo base_url(); ?>assets/img/pltd2.png" style="width:15px;height:15px;"> - Pembangkit (HOP <span id="param_green"></span> hari)</i></label></td>
							<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
							<td><label><i><img src="<?php echo base_url(); ?>assets/img/pltd2_biru.png" style="width:15px;height:15px;"> - Pembangkit (HOP <span id="param_blue"></span> hari)</i></label></td>
							<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
					...
					if ((value.LAT_LVL4) && (value.LOT_LVL4)) {
						...
						if (value.SA_HSDBIO != null) {
							_SA_HSDBIO = '<br>HSD+BIO: ' + toRp(value.SA_HSDBIO) + ' L ' +
								'&nbsp;&nbsp;&nbsp;(HOP: ' + toRp(value.SHO_HSDBIO) + ' Hari)';
...
<script type="text/javascript">
	...
	$('select[name="ID_REGIONAL"]').on('change', function() {
		...
		var vlink_url = '<?php echo base_url() ?>dashboard/peta_jalur/get_options_lv1/' + stateID;
		setDefaultLv1();
		setDefaultLv2();
		setDefaultLv3();
		setDefaultLv4();
	...
	$('select[name="COCODE"]').on('change', function() {
		var stateID = $(this).val();
		var vlink_url = '<?php echo base_url() ?>dashboard/peta_jalur/get_options_lv2/' + stateID;
		setDefaultLv2();
		setDefaultLv3();
		setDefaultLv4();
		if (stateID) {
	...
	$('select[name="PLANT"]').on('change', function() {
		var stateID = $(this).val();
		var vlink_url = '<?php echo base_url() ?>dashboard/peta_jalur/get_options_lv3/' + stateID;
		setDefaultLv3();
		setDefaultLv4();
		if (stateID) {
			bootbox.modal('<div class="loading-progress"></div>');
	...
	$('select[name="STORE_SLOC"]').on('change', function() {
		var stateID = $(this).val();
		var vlink_url = '<?php echo base_url() ?>dashboard/peta_jalur/get_options_lv4/' + stateID;
		setDefaultLv4();
		if (stateID) {
			bootbox.modal('<div class="loading-progress"></div>');
			$.ajax({
