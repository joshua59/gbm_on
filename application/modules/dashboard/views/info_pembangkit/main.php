        ...
        <div class="row-fluid">
            <div class="span6">
                <div id ="index-content" class="well-content no-search">
                    ...
                    <table id="table_stok_bbm" class="table table-responsive table-hover table-bordered table-striped" style="width: 100%">
                        <thead>
                            <tr>
                                ...
                                <th style="text-align:center;">HOP (Hari)</th>
                    ...
                    <label><i>(*Hari Operasi Pembangkit (kali start) : untuk pembangkit PLTU)</i></label>
                    <hr><br>
                    <div class="box-title" id="judul_pembangkit">
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <label><i>(*HOP : Hari Operasi Pembangkit)</i></label><br>
            <label><i>(*Hari Operasi Pembangkit (Hari) : untuk pembangkit selain PLTU)</i></label></br>
            <label><i>(*Hari Operasi Pembangkit (kali start) : untuk pembangkit PLTU)</i></label></br><br><br>
            ...
            <div class="well-content" id="div_peta">
                ...
                <table>
                    <tr>
                        ...
                        <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        <td><label><i><img src="<?php echo base_url();?>assets/img/pltd2_merah.png" style="width:15px;height:15px;"> - Pembangkit (HOP 0-3 hari)</i></label></td>
                        <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        <td><label><i><img src="<?php echo base_url();?>assets/img/pltd2_kuning.png" style="width:15px;height:15px;"> - Pembangkit (HOP 4-6 hari)</i></label></td>
                        <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        <td><label><i><img src="<?php echo base_url();?>assets/img/pltd2.png" style="width:15px;height:15px;"> - Pembangkit (HOP >= 7 hari)</i></label></td>
                        <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
