 ...
 */
class rollback_penerimaan extends MX_Controller {
    private $_title = 'Rollback Penerimaan';
    private $_limit = 10;
    private $_module = 'rollback/rollback_penerimaan';
	private $_urlgetfile = "";
    ...
    public function __construct() {
        ...
        /* Load Global Model */
        $this->load->model('rollback_penerimaan_model', 'tbl_get');
    }
    ...
    public function index() {
        ...
        $data['jenis_transaksi'] = array('1' => 'Penerimaan');
    ...
    public function get_detailtransaksi() {
        ...
        if($jenis == 1){
            ...
            $data['NO_MUTASI_TERIMA'] = $message->NO_MUTASI_TERIMA;
            $data['APPROVE_BY'] = $message->APPROVEL_BY_MUTASI_TERIMA;
            $data['APPROVE_DATE'] = $message->APPROVEL_DATE_MUTASI_TERIMA;
        }
        ...
        if ($this->form_validation->run($this)) {
            ...
            if ($status == 'Disetujui' || $status == 'Disetujui Closing') {
                ...
                if ($value[1] == 'PENERIMAAN') {
                    $save1 = $this->tbl_get->update_penerimaan_satu($sloc, $jenis, $bbm, $idtrans, $mutasi, $tgl, $status, $jnsrollback, $alasan, $approveby, $approvedate, $value, $rollafter);
                    ...
                    $save = $this->tbl_get->update_penerimaan($sloc, $jenis, $bbm, $idtrans, $mutasi, $tgl, $status, $jnsrollback, $alasan, $approveby, $approvedate, $value, $rollafter);
                    ...
                    $save3 = $this->tbl_get->update_penerimaan_tiga($sloc, $jenis, $bbm, $idtrans, $mutasi, $tgl, $status, $jnsrollback, $alasan, $value, $rollafter);
                    ...
                    $save2 = $this->tbl_get->update_penerimaan_dua($sloc, $jenis, $bbm, $idtrans, $mutasi, $tgl, $status, $jnsrollback, $alasan, $rollafter);
    ...
    public function delete() {
        ...
        if ($this->form_validation->run($this)) {
            ...
            // if ($status == 'Belum Disetujui' || $status == 'Belum Disetujui Closing') {
            //     $delete = $this->tbl_get->delete_pemakaian($sloc, $jenis, $bbm, $idtrans, $mutasi, $tgl, $status, $jnsrollback, $alasan);
            ...
            if ($status == 'Disetujui' || $status == 'Disetujui Closing') {
                ...
                if ($value[1] == 'PENERIMAAN') {
                    $delete2 = $this->tbl_get->delete_penerimaan_satu($sloc, $jenis, $bbm, $idtrans, $mutasi, $tgl, $status, $jnsrollback, $alasan, $value, $rollafter);
                    ...
                    $delete1 = $this->tbl_get->delete_penerimaan($sloc, $jenis, $bbm, $idtrans, $mutasi, $tgl, $status, $jnsrollback, $alasan, $value, $rollafter);
                    ...
                    $delete3 = $this->tbl_get->delete_penerimaan_tiga($sloc, $jenis, $bbm, $idtrans, $mutasi, $tgl, $status, $jnsrollback, $alasan, $value, $rollafter);
                    ...
                    $delete2 = $this->tbl_get->delete_penerimaan_dua($sloc, $jenis, $bbm, $idtrans, $mutasi, $tgl, $status, $jnsrollback, $alasan, $rollafter);
